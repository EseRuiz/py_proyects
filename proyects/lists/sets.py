...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    for dk in drink_ingredients:
        if dk in ALCOHOLS:
            return drink_name + ' Cocktail'
    else: return drink_name + ' Mocktail'
...
def tag_special_ingredients(dish):
    ...
    """
    special = set(dish[1])
    return (dish[0],SPECIAL_INGREDIENTS.intersection(special))
...
def compile_ingredients(dishes):
    ...
    """
    dish = set()
    for val in range(0,len(dishes)):
        dish = dish.union(dishes[val])
    return dish
...
def separate_appetizers(dishes, appetizers):
   ...
   # new_plates = #list(set_dishes.symmetric_difference(set_appetizers))
    return list(set_dishes-set_appetizers)
...
b = categorize_dish('Sticky Lemon Tofu', {'tofu', 'soy sauce', 'salt', 'black pepper', 'cornstarch', 'vegetable oil', 'garlic', 'ginger', 'water', 'vegetable stock', 'lemon juice', 'lemon zest', 'sugar'})
c = tag_special_ingredients(('Ginger Glazed Tofu Cutlets', ['tofu', 'soy sauce', 'ginger', 'corn starch', 'garlic', 'brown sugar', 'sesame seeds', 'lemon juice']))
d = compile_ingredients([ {'tofu', 'soy sauce', 'ginger', 'corn starch', 'garlic', 'brown sugar', 'sesame seeds', 'lemon juice'},
...
appetizers = ['Kingfish Lettuce Cups','Avocado Deviled Eggs','Satay Steak Skewers',
              ...
              'Asparagus Puffs']
e = separate_appetizers(dishes, appetizers)
f = singleton_ingredients(example_dishes, EXAMPLE_INTERSECTION)
print(f)